...
const notes = [
  {
    ...
    excerpt: "Architecting agent orchestration layer using Model Context Protocol for multi-model inference and tool execution pipelines.",
    date: "Jul 2026",
    category: "ai",
  ...
  },
  {
    ...
    excerpt: "Designing a microservices architecture with FastAPI, PostgreSQL, and Docker Swarm for cost-effective production deployment.",
    date: "Jun 2026",
    category: "systems",
  ...
  },
  {
    ...
    excerpt: "Migrating portfolio and org sites to Next.js 16 with Tailwind CSS v4's new CSS-first configuration.",
    date: "Jul 2026",
    category: "frontend",
  ...
  },
  {
    ...
    excerpt: "Exploring upgradeable proxy patterns, access control, and gas optimization for ValtheraLabs Web3 infrastructure.",
    date: "Jun 2026",
    category: "blockchain",
