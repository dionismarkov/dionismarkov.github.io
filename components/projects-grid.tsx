...
const projects = [
  {
    ...
    homepage: "https://valtheralabs.io",
    featured: true,
    highlight: true,
  },
  {
    ...
    title: "ValtheraSwap",
    description:
      "ValtheraLabs decentralized exchange product interface with swap, limit-order, liquidity, network, and risk information.",
    tags: ["TypeScript", "React", "Vite", "Web3"],
    status: "shipped",
    year: "2026",
    stars: 0,
    forks: 0,
    url: "https://github.com/ValtheraLabs",
    homepage: "https://valtheraswap.io",
    featured: true,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    homepage: "https://dionismarkov.com",
    featured: false,
  },
]
        ...
        <div className="mb-10 sm:mb-14 flex flex-col gap-6 sm:gap-8 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-3 animate-fade-in-up">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">
              Products and systems I lead, build, or contribute to across the Valthera ecosystem and independent work.
            </p>
          </div>
