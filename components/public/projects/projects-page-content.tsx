...
const projects = [
  {
    ...
    title: "ValtheraLabs",
    description:
      "Software engineering organization building AI-powered platforms, cloud infrastructure, Web3 systems, and developer tools. Ecosystem of production apps and open-source projects.",
    tags: ["AI", "Cloud", "Web3", "SaaS", "Open Source"],
    status: "active",
    year: "2026",
    stars: 0,
    forks: 0,
    url: "https://github.com/ValtheraLabs",
    homepage: "https://valtheralabs.github.io/valtheralabs-site/",
    featured: true,
    highlight: true,
  },
  {
    id: 1,
    title: "valtheralabs-site",
    description:
      "ValtheraLabs official website built with Next.js 15, TypeScript, Tailwind CSS, and Framer Motion. Multi-page investor-grade site with animated components and Web3Forms integration.",
    tags: ["TypeScript", "Next.js 15", "Tailwind", "Framer Motion"],
    status: "shipped",
    year: "2026",
    stars: 0,
    forks: 0,
  ...
  {
    id: 6,
    title: "dionismarkov.github.io",
    description:
      "This portfolio — personal site built with Next.js 16, Tailwind CSS v4, and shadcn/ui. Terminal-inspired aesthetic with dark theme.",
    tags: ["TypeScript", "Next.js 16", "Tailwind v4", "shadcn"],
    status: "shipped",
    year: "2026",
    stars: 0,
    forks: 0,
    url: "https://github.com/dionismarkov/dionismarkov.github.io",
    homepage: "https://dionismarkov.github.io",
    featured: false,
  },
]
